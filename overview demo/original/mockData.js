...
const indicators = {
  ...
  wjzbgsj: { name: '危急值报告时间', code: 'wjzbgsj', module: 2, subSystem: '危急值报告制度', direction: 'negative', status: 'online', type: 'multi-value', desc: '需要同时展示住院、门诊、急诊危急值报告时间（中位数）。指标越低越好。', formula: '危急值报告时间中位数（min）', subValues: { 住院: 12.5, 门诊: 8.3, 急诊: 5.6 } },
  ...
  swbltl5rwcl: { name: '死亡病例讨论5日完成率(%)', code: 'swbltl5rwcl', module: 3, subSystem: '死亡病例讨论制度', direction: 'positive', status: 'online', type: 'fraction', value: 95.6, num: 218, den: 228, desc: '反映死亡病例讨论及时性，同时展示分子分母实际值。指标越高越好。', formula: '5日内完成讨论死亡病例数 / 同期死亡病例总数 × 100%' },
  ywbmzztldswblyfsjfdswblbz: { name: '医务部门组织讨论的死亡病例与发生纠纷的死亡病例比值(%)', code: 'ywbmzztldswblyfsjfdswblbz', module: 3, subSystem: '死亡病例讨论制度', direction: 'positive', status: 'online', type: 'fraction', value: 76.4, num: 84, den: 110, desc: '反映死亡病例讨论的覆盖广度。指标越高越好。', formula: '医务部门组织讨论死亡病例数 / 同期发生纠纷死亡病例总数 × 100%' },
  kzrzcswbltll: { name: '科主任主持死亡病例讨论率(%)', code: 'kzrzcswbltll', module: 3, subSystem: '死亡病例讨论制度', direction: 'positive', status: 'online', type: 'fraction', value: 98.2, num: 224, den: 228, desc: '反映科主任对死亡病例讨论的重视程度。指标越高越好。', formula: '科主任主持讨论死亡病例数 / 同期死亡病例总数 × 100%' },
  swhzbascl: { name: '死亡患者病案上传率(%)', code: 'swhzbascl', module: 3, subSystem: '死亡病例讨论制度', direction: 'positive', status: 'online', type: 'fraction', value: 99.1, num: 226, den: 228, desc: '反映死亡病案归档及时性。指标越高越好。', formula: '死亡患者病案上传数 / 同期死亡患者总数 × 100%' },
